...
var Kua = function () {
  ...
  _createClass(Kua, [{
    ...
    value: function initialize(root) {
      ...
      if (!projectPackage.babel && !_fs2.default.existsSync('.babelrc')) {
        console.log('Creating .babelrc');
        _fs2.default.writeFileSync('.babelrc', JSON.stringify(kuaPackage.babel, null, 2));
      }
      if (!projectPackage.eslintConfig && !(_fs2.default.existsSync('.eslint.js') || !_fs2.default.existsSync('.eslint.json'))) {
        console.log('Creating .eslintrc.json');
        _fs2.default.writeFileSync('.eslintrc.json', JSON.stringify(kuaPackage.eslintConfig, null, 2));
      }
    ...
    value: function daemonize() {
      ...
      var daemon = _daemonize3.default.setup({
        main: _optimist2.default.argv.$0,
    ...
    value: function run(root) {
      ...
      } else if (!_fs2.default.existsSync(this.root + '/task/' + this.task + '.js')) {
