  ...
  _createClass(Kua, [{
    ...
    value: function initialize(root) {
      if (!_fs2.default.existsSync('.babelrc')) {
        ...
        var p = require(_path2.default.join(__dirname, '/../package.json'));
        _fs2.default.writeFileSync('.babelrc', JSON.stringify(p.babel, null, 2));
        _fs2.default.writeFileSync('.eslintrc.json', JSON.stringify(p.eslintConfig, null, 2));
      }
